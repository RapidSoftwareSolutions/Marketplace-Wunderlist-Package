...
$app->post('/api/Wunderlist/markMemberAsAccepted', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['clientId','accessToken','revision','member_id']);
