...
$app->post('/api/Wunderlist/deleteNote', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['clientId','accessToken','noteId','revision']);
    ...
    $requiredParams = ['clientId'=>'client_id','accessToken'=>'access_token','noteId'=>'note_id','revision'=>'revision'];
    $optionalParams = [];
    $bodyParams = [
       'query' => ['note_id','revision']
    ];
